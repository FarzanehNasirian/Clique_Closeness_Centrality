...
_(a) maximum-distance-closeness centrality of $S$ is $C_m(S)=max_{i\in V\setminus S}\delta(i,S)$, and

(b) total-distance-closeness centrality of S is $C_t(S)=\sum_{i\in V\setminus S}\delta(i,S)$_
